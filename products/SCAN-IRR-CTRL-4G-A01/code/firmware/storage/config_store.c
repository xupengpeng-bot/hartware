...
static void config_store_fill_defaults(device_config_t *cfg)
{
    ...
    cfg->protection_config.over_current_limit_a = 0.0f;
    ...
    (void)strncpy(cfg->channel_bindings[3].channel_code, "relay_1", sizeof(cfg->channel_bindings[3].channel_code) - 1U);
    (void)strncpy(cfg->channel_bindings[3].module_code, "relay_output_control", sizeof(cfg->channel_bindings[3].module_code) - 1U);
    (void)strncpy(cfg->channel_bindings[3].channel_role, "relay_output", sizeof(cfg->channel_bindings[3].channel_role) - 1U);
    (void)strncpy(cfg->channel_bindings[3].io_kind, "relay_output", sizeof(cfg->channel_bindings[3].io_kind) - 1U);
    (void)strncpy(cfg->channel_bindings[3].resource_ref, "relay_pump_run", sizeof(cfg->channel_bindings[3].resource_ref) - 1U);
